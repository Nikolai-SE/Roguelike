...
Интерфейс позволяет инкапсулировать запрос на выполнение определенного действия в виде отдельного объекта.
...
> `behaviourState: EnemyBehaviourState`, состояние поведения врага.
...
Класс представляет собой состояние поведения вражеской единицы,

Методы:

> `move(Enemy): EnemyBehaviourState`, выполняет перемещение согласно заданному состояние.
