...
+ Игрок хочет поиграть в рогалик, чтобы снять стресс убивая мобов.
+ Игрок хочет развить свою скорость реакции, тренируясь быстро реагировать на изменения в рогалике.
+ Игрок захочет поиграть в рогалик, чтобы весело провести время. 
+ Если у игрока нет сессии и есть свободное время, которое некуда девать, то игроку просто необходимо поиграть в игру, чтобы потратить свое свободное время.

<!-- *Возможности Gamer (Игрок)*:
+ начать игру, запустив игру;
+ завершить игру, нажав клавишу `Esc` и подтвердив выход;
...
+ посмотреть на инвентарь;
+ посмотреть надетую экипировку;
+ атаковать мобов для получения опыта, чтобы увеличить уровень, силу урона и максимальное здоровье, а также восполненить здоровье;
+ поднять экипировку из мира, поместить ее в инвентарь;
+ надеть экипировку из инвентаря;
+ снять экипировку, поместить ее в инвентарь;
+ узнать уровень моба. -->
