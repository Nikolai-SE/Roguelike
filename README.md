...
> `List<Equipment> unused` - список неиспользуемого обмундированиеобмундирования.
...
> `getDamageDecorator(Int)` - декоратор для накладывания дополнительного эффекта к полученаемому урону.
